...
utils::globalVariables(c(
  ...
  "planning_assumption",
  "population_col",
  "exposure_denominator_col",
  "exposure_denominator_internal_col",
  "exposure_scaling",
  "posterior_lift_mean",
  "posterior_lift_q05",
  "posterior_lift_q95",
  ...
  ,"source_exposure_denominator_col"
  ,"source_exposure_scaling"
  ,"source_variable_n"
  ,"source_variables"
  ,"pressure_handoff_note"
