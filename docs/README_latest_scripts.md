...
- `hier_mmm.R` can generate holiday/control dummies through `holiday_config`, including built-in US major, EU major, global major, week-before/week-of/week-after windows, and custom holiday calendars.
